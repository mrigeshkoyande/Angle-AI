        ...
        <section className="space-y-3">
          ...
          <Card className="p-4 space-y-3">
            ...
            <p className="font-inter text-body-sm text-on-surface-variant">
              If coerced to unlock your app, enter this PIN. Angel AI will open in a simulated normal state while secretly broadcasting emergency location and recording audio.
            </p>
