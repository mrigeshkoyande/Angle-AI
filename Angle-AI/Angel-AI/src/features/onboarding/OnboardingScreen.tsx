...
const steps: OnboardingStep[] = [
  ...
  },
  {
    ...
    body: 'Real-time coaching when you feel unsafe. Angel AI reads your situation and tells you exactly what to do.',
    ...
    <div className="min-h-dvh flex flex-col bg-surface overflow-hidden selection:bg-primary-container/30">
      ...
      <header className="flex justify-between items-center px-5 h-20">
        <div className="flex items-center gap-2">
          <img src="/logo.png" alt="Angel AI" className="w-7 h-7 object-contain" />
          <span className="font-jakarta font-bold text-title-lg text-primary">Angel AI</span>
        </div>
        <button
          onClick={handleSkip}
